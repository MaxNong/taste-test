;(() => {
  var __webpack_modules__ = {
    './src/index.js': (
      ...
      eval(
        'const aa = \'这里是测试app-a\'\n__webpack_require__.e(/*! import() */ "webpack_container_remote_appB_b").then(__webpack_require__.t.bind(__webpack_require__, /*! appB/b */ "webpack/container/remote/appB/b", 23)).then((b) => {\n  console.log(b)\n  console.log(aa)\n  console.log(\'在a中打印\' + b.default)\n})\n\n// import React from "react";\n// import ReactDom from "react-dom";\n// import App from "./app";\n\n// ReactDom.render(<App />, document.getElementById("root"))\n\n\n//# sourceURL=webpack://app-a/./src/index.js?',
      )
    },

    'webpack/container/reference/appB': (
      module,
      __unused_webpack_exports,
      __webpack_require__,
    ) => {
      ...
      module.exports = new Promise((resolve, reject) => {
        if (typeof appB !== 'undefined') return resolve()
        __webpack_require__.l(
          'http://localhost:8000/b.js',
          (event) => {
            if (typeof appB !== 'undefined') return resolve()
            var errorType =
  ...
  ;(() => {
    var chunkMapping = {
      webpack_container_remote_appB_b: ['webpack/container/remote/appB/b'],
    }
    var idToExternalAndNameMapping = {
      'webpack/container/remote/appB/b': [
        'default',
        './b',
        'webpack/container/reference/appB',
      ],
  ...
  ;(() => {
    ...
    __webpack_require__.I = (name, initScope) => {
      ...
      switch (name) {
        case 'default':
          {
            initExternal('webpack/container/reference/appB')
          }
          break
      }
